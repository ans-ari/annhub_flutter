...
TextClassifierParams _$TextClassifierParamsFromJson(Map<String, dynamic> json) {
  return _TextClassifierParams.fromJson(json);
}
...
class _$TextClassifierParamsTearOff {
  ...
  TextClassifierParams fromJson(Map<String, Object> json) {
    return TextClassifierParams.fromJson(json);
  }
}
...
class _$_TextClassifierParams implements _TextClassifierParams {
  ...
  factory _$_TextClassifierParams.fromJson(Map<String, dynamic> json) =>
      _$$_TextClassifierParamsFromJson(json);
  ...
  Map<String, dynamic> toJson() {
    return _$$_TextClassifierParamsToJson(this);
  }
}
...
abstract class _TextClassifierParams implements TextClassifierParams {
  ...
  factory _TextClassifierParams.fromJson(Map<String, dynamic> json) =
      _$_TextClassifierParams.fromJson;
